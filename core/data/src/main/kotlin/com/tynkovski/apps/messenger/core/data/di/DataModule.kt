...
abstract class DataModule {
    ...
    @Binds
    internal abstract fun bindsUsersRepository(usersRepository: UsersRepositoryImpl): UsersRepository

    @Binds
    internal abstract fun bindsMessagesRepository(messagesRepository: MessagesRepositoryImpl): MessagesRepository

    @Binds
    internal abstract fun bindsRoomsRepository(roomsRepository: RoomsRepositoryImpl): RoomsRepository
